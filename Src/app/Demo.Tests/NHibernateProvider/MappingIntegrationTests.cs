using System.IO;
using Demo.NHibernateProvider;
using NHibernate;
using NHibernate.Cfg;
using NHibernate.Tool.hbm2ddl;
using NUnit.Framework;

namespace Demo.Tests.NHibernateProvider
{
    /// <summary>
    ...
    public class MappingIntegrationTests
    {
        ...
        public void CanGenerateDatabaseSchema() {
            using (ISession session = _sessionFactory.OpenSession()) {
                using (TextWriter stringWriter = new StreamWriter("../../../../app/Demo.DB/Schema/UnitTestGeneratedSchema.sql")) {
